...
- ci: harden Dependabot pipeline (concurrency + commit-message scope) ([#142](https://github.com/milanhorvatovic/codex-ai-code-review-action/pull/142))
...
- chore: bump fast-xml-builder from 1.1.5 to 1.2.0 in the npm_and_yarn group across 1 directory ([#130](https://github.com/milanhorvatovic/codex-ai-code-review-action/pull/130))
...
- chore: bump github/codeql-action from 4.35.3 to 4.35.4 in the github-actions group across 1 directory ([#132](https://github.com/milanhorvatovic/codex-ai-code-review-action/pull/132))
...
- chore: bump the dev-dependencies group with 5 updates ([#133](https://github.com/milanhorvatovic/codex-ai-code-review-action/pull/133))
...
- chore: bump the npm group with 2 updates ([#136](https://github.com/milanhorvatovic/codex-ai-code-review-action/pull/136))
...
- chore(deps): bump actions/create-github-app-token from 3.1.1 to 3.2.0 in the github-actions group ([#143](https://github.com/milanhorvatovic/codex-ai-code-review-action/pull/143))
